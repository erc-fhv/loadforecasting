...
class Aggregation_Count():
    ...
    _37_HOUSEHOLDS  = 'data/london_loadprofiles_37households_each.pkl'  # <= Baseline
    _74_HOUSEHOLDS  = 'data/london_loadprofiles_74households_each.pkl'
    _111_HOUSEHOLDS  = 'data/london_loadprofiles_111households_each.pkl'
...
#             TrainingHistory._12_MONTH, ModelInputHistory._1_DAY, UsedModels.ALL, Epochs.DEFAULT),
    ...
    Config_of_one_run(ModelSize.MEDIUM, DoPretraining.YES, DoTransferLearning.YES, Aggregation_Count._74_HOUSEHOLDS, NrOfComunities._20, 
            TrainingHistory._12_MONTH, ModelInputHistory._1_DAY, UsedModels.ALL, Epochs.DEFAULT),
    Config_of_one_run(ModelSize.MEDIUM, DoPretraining.YES, DoTransferLearning.YES, Aggregation_Count._111_HOUSEHOLDS, NrOfComunities._20, 
            TrainingHistory._12_MONTH, ModelInputHistory._1_DAY, UsedModels.ALL, Epochs.DEFAULT),

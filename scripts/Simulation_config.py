...
run_settings = ['modelSize', 'doPretraining', 'doTransferLearning', 'aggregation_Count', 
                'nrOfComunities', 'trainingHistory', 'inputSequenceLength', 'usedModels',
                'epochs']
...
configs = [ 
    Config_of_one_run(ModelSize.SMALL, DoPretraining.YES, DoTransferLearning.YES, Aggregation_Count._74_HOUSEHOLDS,
            NrOfComunities._20, TrainingHistory._18_MONTH, InputSequenceLength._48_HOURS, UsedModels.ALL, Epochs.DEFAULT),
